...
class Web3SampleViewController: UIViewController {
    ...
    init(dexonWalletSDK: DexonWalletSDK) {
...
extension Web3SampleViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch row {
        case .requestAccounts:
            viewController = RequestAccountsViewController(dexonWalletSDK: dexonWalletSDK, callViaWeb3: true)
        case .signPersonalMessage:
            viewController = SignPersonalMessageViewController(dexonWalletSDK: dexonWalletSDK, callViaWeb3: true)
        case .sendTransaction:
            viewController = SendTransactionViewController(dexonWalletSDK: dexonWalletSDK, callViaWeb3: true)
        }
